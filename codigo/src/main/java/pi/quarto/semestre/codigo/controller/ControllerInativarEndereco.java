...
@Controller
@RequestMapping("/paginaInativarEndereco")
public class ControllerInativarEndereco {

    private final EnderecoEntregaDAO enderecoEntregaDAO;
    private HttpServletRequest request;

    public ControllerInativarEndereco(EnderecoEntregaDAO enderecoEntregaDAO, HttpServletRequest request) {
    ...
    public String init(Model model) throws SQLException {
        ...
        return "paginaInativarEndereco";
    }

    @PostMapping
    public String result(@RequestParam Long id) throws SQLException {
        enderecoEntregaDAO.inativarEndereco(id, "Inativo");
