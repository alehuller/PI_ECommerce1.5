...
@Controller
@RequestMapping("/paginaAdicionarEnderecoCheckout")
public class ControllerAdicionarEnderecoCheckout {
    
    private HttpServletRequest request;

    public ControllerAdicionarEnderecoCheckout(HttpServletRequest request) {
    ...
    public String init(final Model model) {
        ...
        return "paginaAdicionarEnderecoCheckout";
    }
    ...
    public ModelAndView result(@ModelAttribute EnderecoEntrega enderecoEntrega) throws NoSuchAlgorithmException, UnsupportedEncodingException, SQLException {
        ...
        ModelAndView successModelAndView = new ModelAndView("redirect:/paginaEndereco");
