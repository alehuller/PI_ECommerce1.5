...
@Controller
@RequestMapping("/paginaEscolhaDeEndereco")
public class ControllerEscolhaDeEndereco {
    
    private final EnderecoEntregaDAO enderecoEntregaDAO;
    private HttpServletRequest request;

    public ControllerEscolhaDeEndereco(EnderecoEntregaDAO enderecoEntregaDAO, HttpServletRequest request) {
    ...
    public String init(Model model) throws SQLException {
        ...
        return "paginaEscolhaDeEndereco";
    }
